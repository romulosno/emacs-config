...
(custom-theme-set-faces
 ...
 '(font-lock-keyword-face ((t (:foreground "#4a005c"))))
 '(font-lock-string-face ((t (:foreground "#244700"))))
 '(font-lock-type-face ((t (:foreground "#7d0e22"))))
 ...
 '(org-level-1 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-2 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-3 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-4 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-5 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-6 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-7 ((t (:extend nil :foreground "#042b75"))))
 '(org-level-8 ((t (:extend nil :foreground "#042b75"))))
