...
(custom-theme-set-faces
 ...
 '(mode-line ((t (:foreground "#000000" :background "#dbdbdb" :box (:line-width (1 . 2) :color "#dbdbdb") :overline "#afafaf"))))
 '(mode-line-inactive ((t (:foreground "#757575" :background "#dbdbdb" :box (:line-width (1 . 2) :color "#dbdbdb")))))
 ...
 '(tab-bar ((t (:foreground "#000000" :background "#dbdbdb" :box (:line-width (1 . 2) :color "#dbdbdb")))))
 '(tab-bar-tab ((t (:foreground "#000000" :background "#cfcfcf" :box (:line-width (1 . 2) :color "#cfcfcf")))))
