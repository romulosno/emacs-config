...
(custom-theme-set-faces
 ...
 '(font-lock-keyword-face ((t (:foreground "#870c2f"))))
 ...
 '(mode-line ((t (:foreground "#000000" :background "#dbdbdb" :box (:color "#afafaf")))))
 '(mode-line-inactive ((t (:foreground "#757575" :background "#dbdbdb" :box (:color "#afafaf")))))
 ...
 '(tab-bar ((t (:foreground "#000000" :background "#dbdbdb" :box (:color "#afafaf")))))
 '(tab-bar-tab ((t (:foreground "#000000" :background "#dbdbdb" :box (:color "#afafaf")))))
