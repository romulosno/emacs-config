...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#fbfbfb" :foreground "#000000"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "#214700"))))
 '(font-lock-comment-face ((t (:foreground "#606150"))))
 '(font-lock-constant-face ((t (:foreground "#a34108"))))
 '(font-lock-function-name-face ((t (:foreground "#7a0066"))))
 '(font-lock-keyword-face ((t (:foreground "#9e2b00"))))
 '(font-lock-string-face ((t (:foreground "#00485e"))))
 '(font-lock-type-face ((t (:foreground "#855d00"))))
 ...
 '(mode-line ((t (:background "#bfbfbf" :foreground "#000000" :box (:line-width (-1 . -1) :color "#afafaf")))))
 '(mode-line-inactive ((t (:background "#d9d9d9" :foreground "#5c5c5c" :box (:line-width (-1 . -1) :color "#afafaf")))))
 '(mode-line-inactive ((t (:foreground "#757575" :background "#bfbfbf" :box (:color "#afafaf")))))
 ...
 '(tab-bar ((t (:background "#bfbfbf" :foreground "#000000" :box (:line-width (-1 . -1) :color "#afafaf")))))
 '(tab-bar-tab ((t (:background "#bfbfbf" :foreground "#000000" :box (:line-width (-1 . -1) :color "#afafaf")))))
