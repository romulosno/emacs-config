...
(custom-theme-set-faces
 ...
 '(tab-bar ((t (:foreground "#000000" :background "#dbdbdb" :box (:line-width (1 . 3) :color "#dbdbdb")))))
 '(tab-bar-tab ((t (:foreground "#000000" :background "#cfcfcf" :box (:line-width (1 . 3) :color "#cfcfcf")))))
