...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#121f4a"))))
 '(font-lock-comment-face ((t (:foreground "#606150"))))
 '(font-lock-constant-face ((t (:foreground "#a85a07"))))
 '(font-lock-function-name-face ((t (:foreground "#910079"))))
 '(font-lock-keyword-face ((t (:foreground "#026075"))))
 ...
 '(mode-line ((t (:foreground "#000000" :background "#bfbfbf" :box (:color "#afafaf")))))
 ...
 '(tab-bar ((t (:foreground "#000000" :background "#bfbfbf" :box (:color "#afafaf")))))
 '(tab-bar-tab ((t (:foreground "#000000" :background "#bfbfbf" :box (:color "#afafaf")))))
