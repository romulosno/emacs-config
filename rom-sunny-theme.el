...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#f2efdc" :foreground "#000000"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "#08545c"))))
 '(font-lock-comment-face ((t (:foreground "#5c5845"))))
 '(font-lock-constant-face ((t (:foreground "#284d2b"))))
 '(font-lock-function-name-face ((t (:foreground "#4a005c"))))
 '(font-lock-keyword-face ((t (:foreground "#55166e"))))
 '(font-lock-string-face ((t (:foreground "#073869"))))
 ...
 '(fringe ((t (:background "#f2eddc"))))
 '(highlight ((t (:bold t))))
 '(isearch ((t (:foreground "#b0e2ff" :background "#4682b4"))))
 '(minibuffer-prompt ((t (:foreground "#171f34"))))
 '(mode-line ((t (:foreground "#000000" :background "#b7c3c4" :box (:color "#a2b6ba")))))
 '(mode-line-inactive ((t (:foreground "#757575" :background "#c9d3d4" :box (:color "#a2b6ba")))))
 ...
 '(tab-bar ((t (:foreground "#000000" :background "#b7c3c4" :box (:color "#a2b6ba")))))
 '(tab-bar-tab ((t (:foreground "#000000" :background "#b7c3c4" :box (:color "#a2b6ba")))))
 '(tab-bar-tab-inactive ((t (:inherit tab-bar :foreground "#959292"))))
 '(warning ((t (:foreground "#805801"))))
 '(whitespace-space ((t (:foreground "#a8a8a8")))))

(provide-theme 'rom-sunny)
;;; rom-sunny-theme.el ends here
