...
(custom-theme-set-faces
 ...
 '(default ((t (:foreground "black" :background "#f5f5e6"))))
 ...
 '(font-lock-function-name-face ((t (:foreground "#002738"))))
 '(font-lock-keyword-face ((t (:foreground "#001c4d"))))
